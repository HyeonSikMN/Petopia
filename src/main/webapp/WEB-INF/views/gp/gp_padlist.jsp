      ...
      <section id="shop">
			...
			<div class="container">
				...
				<c:forEach var="vo" items="${ padlist }">
					<div class="column2" onclick="web('https://www.coupang.com/vp/products/186443832?itemId=913549983&vendorItemId=5282052866&q=%EA%B0%95%EC%95%84%EC%A7%80+%ED%8C%A8%EB%93%9C&itemsCount=36&searchId=7745292aea1e48af8e14abe4bee84adf&rank=0&isAddedCart=')">
						<div class="card">
