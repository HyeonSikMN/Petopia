      ...
      <section id="shop">
			...
			<div class="container">
				...
				<c:forEach var="vo" items="${ feedlist }">
					<div class="column2" onclick="web('https://www.coupang.com/vp/products/62318395?itemId=16754010640&vendorItemId=83935569193&q=%EA%B0%95%EC%95%84%EC%A7%80+%EC%82%AC%EB%A3%8C&itemsCount=36&searchId=346bdbcdc5f449e3a19ccceebb1e05ce&rank=6&isAddedCart=')">
						<div class="card">
