    ...
    <nav>
      ...
      <section id="shop">
			...
			<div class="container">
				...
				<div class="row">
				<c:forEach var="vo" items="${ clothlist }">
					<div class="column2" onclick="web('https://www.coupang.com/vp/products/69953100?itemId=234046244&vendorItemId=3572128210&pickType=COU_PICK&q=%EA%B0%95%EC%95%84%EC%A7%80+%EC%98%B7&itemsCount=36&searchId=37e12f8f69374ebbb1adb0b1dd713d26&rank=1&isAddedCart=')">
						<div class="card">
