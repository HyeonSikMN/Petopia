   ...
   <nav>
      ...
      <section id="shop">
			...
			<div class="container">
				...
				<div class="row">
				<c:forEach var="vo" items="${ leashlist }">
					<div class="column2" onclick="web('https://www.coupang.com/vp/products/5802905182?itemId=9957839661&vendorItemId=81987137682&sourceType=srp_product_ads&clickEventId=fa904da3-44f3-4bd1-8acb-4c06c6bcd0b9&korePlacement=15&koreSubPlacement=1&q=%EA%B0%95%EC%95%84%EC%A7%80+%EB%AA%A9%EC%A4%84&itemsCount=36&searchId=50f7fbc222164dc8b820e224906c0eaa&rank=0&isAddedCart=')">
						<div class="card">
